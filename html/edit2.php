...
if (isset($_POST["submit"])) {
  ...
  $sql = "UPDATE accounts SET name='$first_name',email='$email',balance=' $balance',accID='$account' WHERE id = $id";
      ...
      <form action="" method="post" style="width:50vw; min-width:300px;">
        <div class="row mb-3">
          ...
          <div class="col">
            ...
            <input type="text" class="form-control" name="account" value="<?php echo $row['accID'] ?>">
          </div>
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="balance" value="<?php echo $row['balance'] ?>">
        </div>
