...
<head>
  ...
  <link rel="stylesheet" href="../css/demesew.css" />
  <link rel="stylesheet" href="../css/feyisa.css" />
  <link rel="stylesheet" href="../css/lema.css" />
  <link rel="stylesheet" href="../css/siyum.css" />
  <link rel="stylesheet" href="../css/sitfanos.css" />
  <link rel="stylesheet" href="../css/chala.css">
  <link rel="stylesheet" href="../css/destination-Copy.css">
...
<body>
 <script type="text/javascript" src="https://translate.google.com/translate_a/element.js?cb=loadGoogleTranslate">
    ...
    <div class="image" id="landing-image">
      <div class="landing">
        ...
        <div class="unblurred">
          ...
          <div class="socials">
            <img src="../assets/icons/facebook.svg" alt="facebook" class="fb" />
            <img src="../assets/icons/instagram.svg" alt="instagram" class="ig" />
            <img src="../assets/icons/twitter.svg" alt="twitter" class="tw" />
            <img src="../assets/icons/youtube.svg" alt="youtube" class="yt" />
          </div>
          <div class="navbar">
      ...
      <div class="login-form" id="login-form">
        ...
        <form action="index3.php" class="form-container" method="post">
          <div class="namelogo">
          ...
          <div class="inp">
            <input type="text" name="username" id="email" placeholder="someone123@example.com"
            title="enter a valid email address eg.someone1234@gmail.com"
              required />
          </div>
          <!-- password for login -->
      ...
      <div class="signup-form" id="signup-form">
        ...
        <div class="container">
          ...
          <form action="lab.php" class="form-container" id="form" method="post">
            ...
            <div class="inp">
              <input type="password" id="password-one" placeholder="enter your password with min of 8 characters  " required
                pattern="^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[a-zA-Z]).{8,}$"
                title="Please include at least 1 uppercase character, 1 lowercase character, and 1 number." name="password-one"/>
            </div>
            <!-- confirm password -->
  ...
  <div class="topdest">
    ...
    <a href="#login-form"> <button class="login" id="show-login2" style="padding: 10px 300px;margin-left: 20%;background-color: rgb(70, 10, 10);color: antiquewhite;font-size: 16px;">explore more...</button></a>
    ...
    <div class="contact-us" id="contact-us">
        ...
        <div class="contact-container">
          ...
          <div class="form-wrapper">
            <form action="https://formsubmit.co/bboche651@gmail.com" name="contact-form" method="post">
              <div class="fname">
