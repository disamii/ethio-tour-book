...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO accounts(id,name, accID, email, balance) VALUES (NULL,'$first_name','$account','$email','$balance')";
      ...
      <div class="container d-flex justify-content-center">
         <form action="" method="post" style="width:50vw; min-width:300px;">
            ...
            <div class="mb-3">
               ...
               <input type="" class="form-control" name="balance" placeholder="the amout to be deposited in birr">
            </div>
                   <div>
