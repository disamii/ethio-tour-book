...
<?php
  ...
  if(isset($_POST['submit'])) {        
    ...
    $spl = "SELECT * FROM registration WHERE address = '$email'";
    $result = mysqli_query($conn, $spl);
    $signed_user = $result->fetch_all(MYSQLI_ASSOC);
    $num = mysqli_num_rows($result);
    if($num > 0 && $signed_user[0]['password'] == $password) {
        $_SESSION['user_id'] = $signed_user[0]['id']; 
    ...
    <div class="image" id="landing-image">
      <div class="landing">
        <div class="blur-wrap">
          ...
          <button class="signupbutton" id="show-signupp"onclick="signinpopup()">Be a member</button>
        </div>
        <div class="unblurred">
          ...
          <div class="navbar">
        <a href="home3.php">  <button id="border-only" class="contactus">Home</button></a>  
            <button id="show-login4" class="destinations">destinations</button>
            <button id="show-login3" class="bookings">bookings</button></a>
            <button class="loginn" id="show-login" onclick="loginpopup()">log in</button>
  ...
  <div class="topdest">
    ...
    <div class="contact-us" id="contact-us">
          ...
          <div class="form-wrapper">
            <form action="https://formsubmit.co/bboche651@gmail.com" name="contact-form" method="post">
              ...
              <div class="email">
                ...
                <input type="email" id="block3">
              </div>
              <div class="phoneno">
                <label for="phoneno">Phone </label>
                <input type="number" id="block4">
              </div>
              <div class="subject">
      ...
      <div class="container-three">
        ...
        <div class="content-three" style="font-style:white;"  >
